...
//#include "relevant object headers.h"
...
class TestBasicRomAttributes : public CppUnit::TestFixture
{
    CPPUNIT_TEST_SUITE(TestBasicRomAttributes);
...
int main(int argc, char* argv[])
{
    ...
    ofstream xmlFileOut("cppTestBasicRomResults.xml");
